...
export default function Services() {
  return (
    <>
      {/* Banner (no animation here – video already adds dynamic effect) */}
      <section className="relative h-[70vh] md:h-[70vh]">
        ...
        <div className="relative z-10 flex h-full items-center justify-center">
          <h1 className="text-4xl font-extrabold text-light md:text-5xl">Our Services</h1>
        </div>
      </section>
      ...
      <FadeInOnScroll delay={0.1}>
        <section className="section-wrapper max-w-3xl text-center dark:text-white">
          <p className="mx-auto max-w-xl text-slate-600 dark:text-white">
            From bare‑hull builds to precision paintwork and high‑tech customisations, Ocean Stella delivers craftsmanship you can rely on.
          </p>
        </section>
      </FadeInOnScroll>

      {/* Service Sections with Animation */}
      <ServiceDetail
        img={buildImg}
        title="Boat Making"
        tagline="Hand‑built hulls—engineered for adventure"
        copy="Our build team merges traditional techniques with advanced composites to create vessels that slice through waves and stand the test of time."
        bullets={[
      ...
      <ServiceDetail
        ...
        copy="Inside our climate‑controlled spray booth, we apply multi‑layer marine coatings that resist salt, UV and abrasion—keeping your investment looking new."
        bullets={[
      ...
      <ServiceDetail
        ...
        copy="From smart dashboards to luxury interiors, our specialists integrate cutting‑edge tech and bespoke craftsmanship."
        bullets={[
